...
public class MensagemBeanView extends BeanManagedViewAbstract {
	...
	public String novo() throws Exception {
		...
		objetoSelecionado.setUser_origem(contextoBean.getEntidadeLogada());
		return "";
	}
	...
	public void saveNotReturn() throws Exception {
		...
		if (objetoSelecionado.getUser_destino().getEnt_codigo()
				.equals(objetoSelecionado.getUser_origem().getEnt_codigo())) {
	...
	public void buscarUsuarioDestinoMsg(HttpServletResponse httpServletResponse,
		...
		if (entidade != null) {
			objetoSelecionado.setUser_destino(entidade);
